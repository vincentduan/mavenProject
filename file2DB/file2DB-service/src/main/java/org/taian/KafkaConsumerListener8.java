...
public class KafkaConsumerListener8 implements ConsumerAwareMessageListener<Integer, String> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(KafkaConsumerListener8.class);
