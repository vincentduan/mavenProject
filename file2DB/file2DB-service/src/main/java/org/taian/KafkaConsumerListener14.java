...
public class KafkaConsumerListener14 implements ConsumerAwareMessageListener<Integer, String> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(KafkaConsumerListener14.class);
