...
public class KafkaConsumerListener12 implements ConsumerAwareMessageListener<Integer, String> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(KafkaConsumerListener12.class);
