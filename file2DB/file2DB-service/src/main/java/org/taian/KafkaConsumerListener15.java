...
public class KafkaConsumerListener15 implements ConsumerAwareMessageListener<Integer, String> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(KafkaConsumerListener15.class);
