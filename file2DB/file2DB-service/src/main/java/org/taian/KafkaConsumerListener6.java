...
public class KafkaConsumerListener6 implements ConsumerAwareMessageListener<Integer, String> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(KafkaConsumerListener6.class);
