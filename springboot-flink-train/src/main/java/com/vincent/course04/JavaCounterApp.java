...
//            }
//        }).setParallelism(2);
//        dataSet.writeAsText("/Users/duandingyang/test-data/test4", FileSystem.WriteMode.OVERWRITE).setParallelism(3);
//        JobExecutionResult javaCounterApp = executionEnvironment.execute("JavaCounterApp");
        ...
        text.writeAsText("~/test-data/test4", FileSystem.WriteMode.OVERWRITE).setParallelism(3);
        JobExecutionResult javaCounterApp = executionEnvironment.execute("JavaCounterApp");
